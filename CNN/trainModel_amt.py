...
def CNN_word_word(embedding_matrix):
    ...
    with open(cur_dir_path + 'savedmodelFiles_amt/' + str(sys.argv[1]) + '_CNN_word_word_model.json', "w") as json_file:
        json_file.write(model_json)
    # serialize weights to HDF5
    model.save_weights(cur_dir_path + 'savedmodelFiles_amt/' + str(sys.argv[1]) + '_CNN_word_word_model.h5')
